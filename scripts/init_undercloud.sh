...
sudo yum update -y
sudo yum install -y python-tripleoclient rhosp-director-images rhosp-director-images-ipa vim telnet wget tcpdump nmap tmux git crudini jq bind-utils net-tools yum-utils libguestfs-tools bash-completion bash-completion-extras ceph-ansible
reboot
